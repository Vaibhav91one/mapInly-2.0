...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col rounded-md border border-border bg-secondary shadow-sm overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-border">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex items-center justify-center size-8 hover:bg-secondary/80 transition-colors",
...
type MapClickHandlerProps = {
  /** Callback when the map is clicked (not on markers or controls) */
